...
# ---------- 美股/日韩题材板块 ----------
# 东财无美股题材板块接口（仅科技/金融等大类），采用「代表股 → 板块涨跌幅」方案：
# 每个板块配若干代表股 secid，涨跌幅取成分股简单平均。secid 前缀：105=纳斯达克、
# 106=纽交所、107=美交所、176=日股、177=韩股。
US_THEME_SECTORS = [
    {"key": "memory", "name": "存储芯片",
     "secids": ["105.MU", "105.WDC", "105.STX", "105.SIMO", "177.000660"]},
    {"key": "cpo", "name": "CPO·光模块",
     "secids": ["106.COHR", "105.LITE", "105.AAOI", "106.GLW", "106.CIEN"]},
    {"key": "gpu", "name": "AI算力·GPU",
     "secids": ["105.NVDA", "105.AMD", "105.AVGO", "105.ASML", "105.TXN"]},
    {"key": "semis", "name": "半导体设备",
     "secids": ["105.AMAT", "105.LRCX", "105.KLAC", "176.2760", "176.6857"]},
    {"key": "foundry", "name": "晶圆代工",
     "secids": ["106.TSM", "105.INTC", "105.QCOM", "105.SIMO"]},
    {"key": "kr_memory", "name": "韩股·存储",
     "secids": ["177.005930", "177.000660"]},
    {"key": "jp_semis", "name": "日股·半导体",
     "secids": ["176.2760", "176.6857"]},
]
